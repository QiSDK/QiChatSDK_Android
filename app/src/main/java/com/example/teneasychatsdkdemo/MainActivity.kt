...
//httos://csh5.hfxg.xyz,https://csapi.dev.stream
    ...
    private fun initChatSDK(baseUrl: String){
        ...
        //666668，364154
        chatLib.init("COYBEAUYASDyASiG2piD9zE.te46qua5ha2r-Caz03Vx2JXH5OLSRRV2GqdYcn9UslwibsxBSP98GhUKSGEI0Z84FRMkp16ZK8eS-y72QVE2AQ", "", wssUrl, 666665, "9zgd9YUc", 0, getCustomParam(), 20, this, 1769174999, "code199", "QiChatTestApp")
    ...
    private fun sendMsg(){
        ...
        chatLib.sendMessage(sayHello, CMessage.MessageFormat.MSG_TEXT, 1, 0, withAutoReplyBuilder.build(), 0, "", CMessage.MsgSourceType.MST_CARD)//, CMessage.MsgSourceType.MST_CARD
